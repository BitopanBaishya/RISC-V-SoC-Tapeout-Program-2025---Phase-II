...
Welcome!  
This repository serves as the **master documentation hub** for **Phase 2** of my journey in the **RISC-V SoC Tapeout Program 2025**. Unlike Phase 1, which followed a structured weekly cadence, this phase is significantly more **intensive and execution-focused**, and is therefore documented on a **daily basis**.

Phase 2 marks the transition from guided learning to **hands-on SoC implementation**, where each day contributes directly toward the final tapeout. To accurately capture this pace and depth, the entire documentation is organized as **day-wise logs**, reflecting real design work, debugging cycles, and engineering decisions as they happen.
